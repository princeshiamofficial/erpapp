...
interface AddUserDialogProps {
  onUserAdded: (newUser: Omit<User, 'id'>) => Promise<void>; // Changed to accept Omit<User, 'id'>
  currentUser: User; 
...
export function AddUserDialog({ onUserAdded, currentUser, children }: AddUserDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const newUser: Omit<User, 'id'> = { // User ID will be generated by Firestore service
      name,
      email,
      role,
    ...
    try {
      ...
      // Toast is handled in UsersPage now after successful fetch
      setIsOpen(false);
    } catch (error) {
