          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
                <thead className="sticky top-0 z-20">
                    <tr>
                        <th className="sticky left-0 z-10 border p-2 align-top bg-orange-200 dark:bg-orange-800/50 w-32 min-w-[128px]">
                    ...
                    {monthDays.map(date => {
                        ...
                        return (
                            <tr key={dateKey} className="hover:bg-muted/30">
                                <td className="sticky left-0 z-10 border p-2 text-center bg-orange-200 dark:bg-orange-800/50">
