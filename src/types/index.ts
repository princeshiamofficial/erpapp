...
export type ProjectStatusType = 'Project Pending' | 'CR Clearance' | 'Docs Pending' | 'CO Clearance' | 'Cancel' | 'On Design' | 'On Hold' | 'Logistics' | 'Courier' | 'Delivered' | 'Business Closed';
