...
const navItems: NavItem[] = [
  ...
  { href: "/my-daily-routine", label: "MY Daily Routine", icon: ClipboardList, roles: ["SYSTEM_ADMIN", "ADMIN", "CRM", "DESIGNER_REPRESENTATIVE", "VENDOR", "LR", "CO"] },
  {
    ...
    label: "CRM",
    icon: Shield,
    roles: ["SYSTEM_ADMIN", "ADMIN", "CRM", "CR"],
    href: "",
    subItems: [
      { href: "/pipeline", label: "Pipe Line", icon: Briefcase, roles: ["SYSTEM_ADMIN", "ADMIN", "CRM", "CR"] },
      { href: "/crm/all-districts-data", label: "ADD", icon: Map, roles: ["SYSTEM_ADMIN", "ADMIN", "CRM", "CR"] },
  ...
  { href: "/deliveries", label: "Deliveries", icon: Truck, roles: ["SYSTEM_ADMIN", "ADMIN"] },
