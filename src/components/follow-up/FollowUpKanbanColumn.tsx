...
export function FollowUpKanbanColumn({
    ...
    return (
        <div
            ref={setNodeRef}
            className={cn(
                "w-[300px] shrink-0 flex flex-col bg-muted/20 sm:bg-muted/30 rounded-2xl overflow-hidden transition-all duration-300 ease-in-out h-full border border-border/10",
