...
export default function Gifts2Page() {
    ...
    <>
      <div className="space-y-6 p-1 sm:p-0">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 page-header">
          <div><h1 className="page-title">Client Gifts (Gifts 2)</h1><p className="page-description">Manage and track gifts given to clients.</p></div>
