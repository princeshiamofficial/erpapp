...
export const FollowUpKanbanColumn = React.memo(({
    ...
    return (
        <div
            ref={setNodeRef}
            className={cn(
                "w-[280px] sm:w-[300px] shrink-0 flex flex-col bg-muted/20 sm:bg-muted/30 rounded-lg overflow-hidden transition-all duration-300 ease-in-out h-full border border-border/30",
                isOver ? 'ring-2 ring-primary shadow-xl scale-[1.01] bg-muted/40' : 'shadow-sm'
            )}
        >
            <div 
                className={cn(
            ...
            <ScrollArea className="flex-1 custom-scrollbar-hidden">
