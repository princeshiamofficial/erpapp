                    ...
                    {showLikelihoodChart && (
                        <>
                            <div className="h-8 w-px bg-border mx-2"></div>
                             <div className="flex flex-col items-center justify-center p-2 rounded-lg bg-gradient-to-tr from-purple-500/10 to-pink-500/10 border border-purple-200/50 dark:border-purple-800/50">
